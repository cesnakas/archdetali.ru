...
$APPLICATION->SetPageProperty("title","Вопросы и ответы – студия Arch Detali");

$APPLICATION->SetPageProperty("description","Вопросы и ответы. Закажите дизайн интерьера любой сложности от компании Arch Detali");
?>
