		...
		<div class="order-block">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-5 valign">
					<span class="btn btn-default btn-lg" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['aspro_stroy_form']['aspro_stroy_example'][0]?>" data-name="example" data-autoload-STRING="Автозаполнение строки">Пример формы</span>
				</div>
...
<div class="row">
	<div class="col-md-6">
		...
		<div class="flexslider" data-plugin-options='{"animation":"slide", "animationLoop": true, "maxItems": 1}'>
			<ul class="slides">
				<li>
					<img alt="" class="img-responsive" src="<?=SITE_TEMPLATE_PATH?>/images/project.jpg">
				</li>
				<li>
					<img alt="" class="img-responsive" src="<?=SITE_TEMPLATE_PATH?>/images/project.jpg">
				</li>
	...
	<div class="col-md-6">
		<h2>Fancybox</h2>
		<a class="img-thumbnail fancybox pull-left"	href="<?=SITE_TEMPLATE_PATH?>/images/project.jpg" data-plugin-options='{"type":"image"}'>
