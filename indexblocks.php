	...
	<?if($bCatalogFilterIndex):?>	
		<div class="row">
			<div class="maxwidth-theme">
				<div class="col-md-12">
					<?$APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "front", array(
			...
			<div class="row">
				<div class="maxwidth-theme">
					<div class="col-md-12">
						...
						<?$APPLICATION->IncludeComponent("bitrix:news.list", "front-projects", array(
	"IBLOCK_TYPE" => "aspro_stroy_content",
                        ...
                        <div class="col-md-12">
                            <? $APPLICATION->IncludeComponent(
                                ...
                                array("AREA_FILE_SHOW" => "file",
                                    "PATH" => $APPLICATION->GetTemplatePath("include_areas/work-stages.php")), false); ?>
				...
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-12">
							...
							"bitrix:main.include", "",
							array("AREA_FILE_SHOW" => "file",
							"PATH" => $APPLICATION->GetTemplatePath("include_areas/sotrudniki_mainpage.php")), false); ?>
						</div>
					</div>
				</div>
			</div>
		</div>
	</div>*/?><!--Блок сотрудники на главной-->
