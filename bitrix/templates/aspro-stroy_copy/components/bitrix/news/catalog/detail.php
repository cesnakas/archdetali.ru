...
<?	
	...
	$decription_postfix = "";
	if ($FLOOR_SPACE) {
		$title_postfix = ", площадь ".$FLOOR_SPACE.' м2 | Портфолио компании "Arch Detali"';
		$decription_postfix = ', площадь '.$FLOOR_SPACE.' м2. Портфолио компании "Arch Detali". Разработка дизайна интерьеров в Москве по привлекательным ценам от компании "Arch Detali".';
	}
	else {
		$title_postfix = ' | Портфолио компании "Arch Detali"';
		$decription_postfix = '. Портфолио компании "Arch Detali". Разработка дизайна интерьеров в Москве по привлекательным ценам от компании "Arch Detali".';
	}
