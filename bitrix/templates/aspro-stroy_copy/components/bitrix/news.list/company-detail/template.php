    ...
    <div class="company detail">
        <div class="items row">
            <? foreach ($arResult['ITEMS'] as $key => $arItem): ?>
                ...
                ?>
                <div class="col-md-12">
                    <div class="item_block<?= ($bImage ? '' : ' wti') ?>"
                        ...
                        <? if ($arItem['FIELDS']['DETAIL_PICTURE']): ?>
                            ...
                            <? if ($arItem['PROPERTIES']['PHOTOPOS']['VALUE_XML_ID'] == 'LEFT'): ?>
                                <div class="detailimage image-left col-md-4 col-sm-4 col-xs-12"><a
                                        href="<?= $arItem['DETAIL_PICTURE']['SRC'] ?>" class="fancybox"
                                        title="<?= $atrTitle ?>"><img src="<?= $arItem['DETAIL_PICTURE']['SRC'] ?>"
                                                                      class="img-responsive" title="<?= $atrTitle ?>"
                                                                      alt="<?= $atrAlt ?>"/></a></div>
                            ...
                            <? else: ?>
                                <div class="detailimage image-wide"><a href="<?= $arItem['DETAIL_PICTURE']['SRC'] ?>"
                                                                       class="fancybox" title="<?= $atrTitle ?>"><img
                                            src="<?= $arItem['DETAIL_PICTURE']['SRC'] ?>" class="img-responsive"
                                            title="<?= $atrTitle ?>" alt="<?= $atrAlt ?>"/></a></div>
                            <? endif; ?>
                        <? endif; ?>
                        <div class="content">
                            ...
                            <? $APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    'AREA_FILE_SHOW' => 'file',
                                    'PATH' => SITE_DIR . 'include/about_us_team_block.php',
                                    'EDIT_TEMPLATE' => ''
                                )
                            ); ?>
                            <? /* team block end */ ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-5 valign">
                                            <span class="btn btn-default btn-lg" data-event="jqm"
                                                  data-param-id="<?= CCache::$arIBlocks[SITE_ID]['aspro_stroy_form']['aspro_stroy_question'][0] ?>"
                                                  data-name="order_services"
                                                  data-autoload-service="<?= $arItem['NAME'] ?>"><span><?= (strlen($arParams['S_ORDER_SERVICE']) ? $arParams['S_ORDER_SERVICE'] : GetMessage('S_ORDER_SERVICE')) ?></span></span>
                                        </div>
                            ...
                            <? $APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    'AREA_FILE_SHOW' => 'file',
                                    'PATH' => SITE_DIR . 'include/about_us_brands_block.php',
                                    'EDIT_TEMPLATE' => ''
                                )
                            ); ?>
                            <? /* brands block end */ ?>
                            ...
                            <? /* our partners block start */ ?>
                            <? $APPLICATION->IncludeComponent(
                                'bitrix:main.include',
                                '',
                                Array(
                                    'AREA_FILE_SHOW' => 'file',
                                    'PATH' => SITE_DIR . 'include/our_partners_block.php',
                                    'EDIT_TEMPLATE' => ''
                                )
                            ); ?>
                                    ...
                                    <? for ($i = 1; $i <= 4; $i++) { ?>
                                        <? if (strlen($arItem['DISPLAY_PROPERTIES']['property' . $i]['VALUE'])): ?>
                                            <div class="col-md-3 col-sm-6 col-xs-6">
                                                <div class="value spincrement1" <?/*data-value=""*/?>>
                                                    <?= $arItem['DISPLAY_PROPERTIES']['property' . $i]['VALUE'] ?>
                                                </div>
                                                <div
                                                    class="text"><?= $arItem['DISPLAY_PROPERTIES']['property' . $i]['NAME'] ?></div>
                                            </div>
                                        <? endif; ?>
                                    <? } ?>
                                </div>
                                                    ...
                                                    <div class="item wline">
                                                        <? $arImgFilter = array(
                                                            array(
                                                                ...
                                                                "size"           => "real",
                                                                'alpha_level'    => '100',
                                                                "file"           => $_SERVER["DOCUMENT_ROOT"]."/bitrix/images/watermark_comp_gallery.png"
                                                            )
                                                        );
                                                        $thumbBIG = CFile::ResizeImageGet($arPhoto["DETAIL"], array('width' => 1000, 'height' => 1000),BX_RESIZE_IMAGE_PROPORTIONAL, true, $arImgFilter); ?>
                                                        <a href="<?=$thumbBIG['src']; ?>"
                                                           class="dark_block_animate fancybox_ext" rel="big_gallery"
                                                           title="<?= $arPhoto["TITLE"]; ?>"></a>

                                                        <div class="img_block scale_block_animate"
                                                             style="background-image: url('<?= $arPhoto["PREVIEW"]["src"]; ?>');">
