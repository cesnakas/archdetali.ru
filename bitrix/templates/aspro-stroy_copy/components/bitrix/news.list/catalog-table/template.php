                    ...
                    <div class="text">
                        <div class="cont">
                            ...
                            <div class="item-product-properties"><span class="item-icon price-icon"></span>
                                <?php echo number_format($price_1, 2, ',', ' ');  ?>ðóá.</div>
                            <?php if($srok > 1 AND $srok < 5): ?>
                            <div class="item-product-properties"><span class="item-icon time-icon"></span>
                                <?php echo $srok;?> ìåñÿöà.</div>
                            <?php endif; ?>
                            <?php if($srok == 1 OR $srok < 1): ?>
                            <div class="item-product-properties"><span class="item-icon time-icon"></span> 1 ìåñÿö.</div>
                            <?php endif; ?>
                            <?php if($srok > 4): ?>
                            <div class="item-product-properties"><span class="item-icon time-icon"></span>
                                <?php echo $srok;?> ìåñÿöåâ.</div>
                            <?php endif; ?>
                            <?php endif; ?>
