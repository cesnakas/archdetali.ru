					...
					<div class="row">
							...
							<div class="col-md-3">
								<div class="image">
									<?if($bDetailLink):?><a href="<?=$arItem['LIST_PAGE_URL']?>"><?endif;?>
										<img src="<?=$imageSrc?>" alt="" title="" class="img-responsive" />
						...
						<div class="col-md-<?=($bImage ? '9' : '12');?>">
							<div class="info">	
										...
										<?for($i=1;$i<=4;$i++){?>
											<?if(strlen($arItem['DISPLAY_PROPERTIES']['property'.$i]['VALUE'])):?>
												<div class="col-md-3 col-sm-6 col-xs-6">
														...
														<div class="value spincrement1" data-value="<?=$arItem['DISPLAY_PROPERTIES']['property'.$i]['VALUE']?>"><?=$arItem['DISPLAY_PROPERTIES']['property'.$i]['VALUE']?></div>
								...
								<?if(strlen($arItem['PROPERTIES']['TEXT_UNDER_PROPERTY']['~VALUE']['TEXT'])):?>
									<div class="text">
										<?=$arItem['PROPERTIES']['TEXT_UNDER_PROPERTY']['~VALUE']['TEXT']?>
									</div>
								<?endif;?>
							</div>
						</div>
