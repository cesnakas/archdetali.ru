					...
					<div class="item<?=($bShowImage ? '' : ' wti')?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product">
						<div class="row">
							...
							<div class="<?=($bShowImage ? 'col-md-11 col-sm-11 col-xs-10' : 'col-md-12 col-sm-12 col-xs-12')?>">
								<div class="text">
									<div class="row">
										<?$colmd = 12 - ($bStatusLabel ? 2 : 0) - ($bPrice ? 3 : 0) - ($bOrderButton ? 2 :0);?>
										...
										<?if($bOrderButton):?>
											<div class="col-md-2 col-sm-3 col-xs-6">
												<span class="btn btn-default btn-sm pull-right" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['aspro_stroy_form']['aspro_stroy_order_product'][0]?>" data-product="<?=$arItem['NAME']?>" data-name="order_product"><?=(strlen($arParams['S_ORDER_PRODUCT']) ? $arParams['S_ORDER_PRODUCT'] : GetMessage('S_ORDER_PRODUCT'))?></span>
											</div>
										<?endif;?>
									</div>
								</div>
