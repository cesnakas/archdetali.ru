...
$MESS["REQUIRED_FIELD"] = "Обов'язкове поле";
...
$MESS["ADD_COMMENT"] = "Додати коментар";
$MESS["ADD_COMMENT_TITLE"] = "Додати коментар (Ctrl + Enter)";
$MESS["MORE_COMMENTS"] = "Показати попередні коментарі";
$MESS["COMMENTS_N_FROM_M"] = "#N# з #M#";
?>