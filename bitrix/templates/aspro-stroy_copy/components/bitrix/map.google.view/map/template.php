...
<div class="module-map">
	...
	<div class="map-wr">
		<!--<a href="" class="see_map">Посмотреть на большой карте</a>-->
	<?
...
<?
	for($i = 0; $i < $cnt; $i++):
?>
	BX_GMapAddPlacemark(<?echo CUtil::PhpToJsObject($arResult['POSITION']['PLACEMARKS'][$i])?>, '<?echo $arParams['MAP_ID']?>', '<?=$templateFolder;?>');
<?
	endfor;
?>
}
