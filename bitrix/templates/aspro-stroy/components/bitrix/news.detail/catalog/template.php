											...
											<ul class="slides items">
												...
												<?foreach($arResult['GALLERY'] as $i => $arPhoto):?>
													<li class="col-md-12 col-sm-12 item">
														<a href="<?=$arPhoto['DETAIL']['SRC']?>" class="fancybox" rel="gallery" target="_blank" title="">
															<img src="<?=$arPhoto['PREVIEW']['src']?>" class="img-responsive inline" title="" alt="" itemprop="image" />
															<span class="zoom">
																<i></i>
															</span>
														</a>
					...
					<?foreach($arResult['PLANIROVKA'] as $arFile){?>
						<div class="col-md-<?=$col;?> galery">
							<div class="plans_block border_block item">
								<div class="img_block">
									<a href="<?=$arFile['DETAIL']['SRC']?>" class="fancybox blink" rel="plans" target="_blank" title="">
										<img class="img-responsive" src="<?=$arFile["PREVIEW"]["src"]?>" alt="" title=""/>
										<span class="zoom">
											<i></i>
										</span>	
									</a>
