...
<?	
	...
	$decription_postfix = "";
	if ($FLOOR_SPACE) {
		$title_postfix = ", площадь ".$FLOOR_SPACE.' м2 | Портфолио компании "Люкс-Дизайн"';
		$decription_postfix = ', площадь '.$FLOOR_SPACE.' м2. Портфолио компании "Люкс-Дизайн". Разработка дизайна интерьеров в Москве по привлекательным ценам от компании "Люкс-Дизайн".';
	}
	else {
		$title_postfix = ' | Портфолио компании "Люкс-Дизайн"';
		$decription_postfix = '. Портфолио компании "Люкс-Дизайн". Разработка дизайна интерьеров в Москве по привлекательным ценам от компании "Люкс-Дизайн".';
	}
	mb_convert_variables("windows-1251", "UTF-8", $title_postfix, $decription_postfix);
	$title = $APPLICATION->GetTitle().$title_postfix;
	$description = $APPLICATION->GetTitle().$decription_postfix;
