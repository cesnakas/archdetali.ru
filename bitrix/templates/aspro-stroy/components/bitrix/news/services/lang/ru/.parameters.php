...
$MESS['T_GOODS'] = 'Текст подзаголовка "Проекты в которых использовалась услуга"';
$MESS['T_SERVICES'] = 'Текст подзаголовка "Услуги"';
$MESS['T_PROJECTS'] = 'Текст подзаголовка "Выполненные проекты"';
$MESS['T_REVIEWS'] = 'Текст подзаголовка "Отзывы клиентов"';
