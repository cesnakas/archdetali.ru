...
<?if($arResult["ITEMS"]){?>
	...
	<div class="bx_filter bx_filter_<?=strtolower($arParams["FILTER_VIEW_MODE"]);?> catalog">
						...
						<div class="bx_filter_button_box active">
							<div class="bx_filter_block">
								<div class="bx_filter_parameters_box_container">
									...
									<input class="bx_filter_search_button btn btn-default btn-sm" type="submit" id="set_filter" name="set_filter"  value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
