	...
	<div class="row_custom">
		<div class="maxwidth-theme">
			<div class="col-md-12_custom">
				<div class="banners-small front banners-small-custom1">
								...
								<div class="item<?=($bImage ? '' : ' wti')?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
									<?if($bImage):?>
										<div class="image">
											...
											<img src=<?=$imageSrc?> alt="<?=(isset($arItem['IPROPERTY_VALUES']['ELEMENT_DETAIL_PICTURE_FILE_ALT']) && strlen($arItem['IPROPERTY_VALUES']['ELEMENT_DETAIL_PICTURE_FILE_ALT']) ? $arItem['IPROPERTY_VALUES']['ELEMENT_DETAIL_PICTURE_FILE_ALT'] : $arItem['NAME'])?>" title="<?=(isset($arItem['IPROPERTY_VALUES']['ELEMENT_DETAIL_PICTURE_FILE_TITLE']) && strlen($arItem['IPROPERTY_VALUES']['ELEMENT_DETAIL_PICTURE_FILE_TITLE']) ? $arItem['IPROPERTY_VALUES']['ELEMENT_DETAIL_PICTURE_FILE_TITLE'] : $arItem['NAME'])?>" />
											<?if($bLink):?></a><?endif;?>
										</div>
									<?endif;?>
									<div class="title">
